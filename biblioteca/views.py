...
def home_view(request):
    return render(request,"general/home.html") # la funsion render necesita 2 parametros un request y un archivo para renderizar 
...
""" def contact_view(request):
    if request.POST:
        ...
        print(f'Se ha enviado un email de {nombre}, procedente de {email} con el comentario:{comentario}')
